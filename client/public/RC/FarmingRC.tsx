                ...
                <div className={'widget'}>
                    ...
                    <div className={'widget__content'}>
                        <div className={'block'}>
                            ...
                            cost: {database.buildings.find(BuildingID.GardenBed).cost}/{this.props.container.get<WalletInterface>(ServiceID.Wallet).value},
                            requireItems: , count: {this.state.count}/{this.state.max}
                        </div>
                            ...
                            {_.map(this.state.gardenBeds, (gardenBed, index, collection) => {
                                return <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <button
                                            className={'btn btn_default ' + (!gardenBed.gardenBed.isReadyToHarvest() ? 'btn_default_disabled' : '')}
                                            disabled={!gardenBed.gardenBed.isReadyToHarvest()} onClick={(event) => {
                                            event.preventDefault();
