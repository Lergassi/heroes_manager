                            ...
                            {_.map(this.state.items, (item, index, collection) => {
                                return <tr key={index}>
                                    <td>
                                        ...
                                        <span
                                            className={sprintf('icon icon_%s icon_32 icon_first-column-column-padding', database.items.data.iconId(item.itemID))}></span>
                                    ...
                                    <td>{database.recipes.data.requireItems(item.itemID, (itemID, count) => {
                                        return <div
                                            key={itemID}>{itemID}: {count}/{this.props.playerItemStorage.containItem(itemID)}</div>
                                    })}</td>
