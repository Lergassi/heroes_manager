 ...
 */
export default class HeroListSelectRC extends React.Component<HeroListSelectRCProps, HeroListSelectRCState> implements MainHeroListRender {
    ...
    render() {
        return (
            <div>
                ...
                <button onClick={this.addHero}>addHero</button>
            </div>
        );
    }
}