...
// let csv_created_items_data = _manual_created_items_data;
// let auto_generated_equip_db_data = _auto_generated_equip_db_data;
...
export const items = {
    ...
    iconId: function (ID: ItemID): string {
        // return items_db[ID]?.IconID ?? IconID.Question02;
