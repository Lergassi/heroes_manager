...
export default class ShorHeroViewer {
    view(hero: GameObject) {
        ...
        hero.get<ExperienceComponent>(ComponentID.Experience).view((data) => {
        ...
        hero.get<HealthPointsComponent>(ComponentID.HealthPoints).view((data) => {
